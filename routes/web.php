...
Route::get('/admin/portafoliosActivos2023', [App\Http\Controllers\PortafoliosActivosController2023::class, 'index'])->middleware('auth');

Route::get('/showPortafoliosActivos2023', [App\Http\Controllers\PortafoliosActivosController2023::class, 'getTraders2023'])->middleware('auth');

Route::get('/admin/getPortafoliosActivos2023', [App\Http\Controllers\PortafoliosActivosController2023::class, 'getPruebasVida2023'])->middleware('auth');
...
Route::get('/admin/equityBalance2023/{id}', [App\Http\Controllers\GraficaController2023::class, 'index'])->middleware('auth');
...
Route::get('/admin/portafolioGraph2023', [App\Http\Controllers\PortafoliosGraphController2023::class, 'index'])->middleware('auth');

Route::get('/admin/getPortafolioGraph2023', [App\Http\Controllers\PortafoliosGraphController2023::class, 'getPortafolioGraph2023'])->middleware('auth');
...
Route::get('/admin/historicos2023', [App\Http\Controllers\HistoricoOperacionesController2023::class, 'index'])->name('HistoricoOperaciones')->middleware('auth');

Route::get('/admin/historicosShow2023', [App\Http\Controllers\HistoricoOperacionesController2023::class, 'getHistoricos2023'])->middleware('auth');
