...
class IndexUSDCADCHFController extends Controller
{
    ...
    public function getMonedasUSDCADCHF()
    {
     ...
     //    ->orwhere('moneda', 'USDMXN')
       ...
       // ->orderByDesc(DB::raw('FIELD(moneda, USDCAD, USDCHF, CADCHF)'))
         
        
        
        
        //DB::table('valores_moneda')
         //   ->select(DB::raw('DISTINCT moneda'))
         //   ->where('moneda', 'like', '%USD%')
          //  ->where('moneda', 'EURUSD')
            //->orwhere('moneda', 'GBPUSD')
    ...
    public function getIndexUSDUSDCADCHF(Request $request)
    {
