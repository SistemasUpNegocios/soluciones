...
<head>
    ...
    <title>Operaciones Magic Number</title>
...
<body class="analisis-imprimir">
    ...
    <div class="pagetitle">
        <p style="font-size: 20px; text-transform: uppercase;" class="text-center"><b>Operaciones Magic Number</b></p>
        <p style="font-size: 20px; text-transform: uppercase;" class="text-center"><b>Serie:</b> <span > @if ($numero == 0) Todas
            @else
            {{$numero}} 
            @endif </span></p>
    </div>
                    ...
                    @for ($i = 0; $i < 9; $i++)
                        ...
                        @if ($voleurusd_sell_array[$i] == $voleurusd_buy_array[$i] && $sumabuy_sell > 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #FF6000; color:white; font-weight:500">{{ $array_eurusd[$i] }}
                            </td>
                        @elseif($voleurusd_sell_array[$i] != $voleurusd_buy_array[$i] && $sumabuy_sell > 0)
                            ...
                            @elseif ($voleurusd_sell_array[$i] == $voleurusd_buy_array[$i] && $sumabuy_sell < 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #D21312; color:white; font-weight:500">{{ $array_eurusd[$i] }}
                            </td>
                        @else
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 9; $i++)
                        ...
                        @if ($volgbpusd_sell_array[$i] == $volgbpusd_buy_array[$i] && $sumabuy_sell > 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #FF6000; color:white; font-weight:500">{{ $array_gbpusd[$i] }}
                            </td>
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 9; $i++)
                        ...
                        @elseif($volnzdusd_sell_array[$i] != $volnzdusd_buy_array[$i] && $sumabuy_sell > 0)
                            ...
                            @elseif ($volnzdusd_sell_array[$i] == $volnzdusd_buy_array[$i] && $sumabuy_sell < 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #D21312; color:white; font-weight:500">
                                {{ $array_nzdusd[$i] }}</td>
                        @else
                ...
                <tr>
                    ...
                    @for ($i = 0; $i < 9; $i++)
                        ...
                        @if ($volusdcad_sell_array[$i] == $volusdcad_buy_array[$i] && $sumabuy_sell > 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #FF6000; color:white; font-weight:500">
                                {{ $array_usdcad[$i] }}</td>
                        @elseif($volusdcad_sell_array[$i] != $volusdcad_buy_array[$i] && $sumabuy_sell > 0)
                            <td data-priority="0" scope="col"
                                style="background-color: #285430; color:white; font-weight:500">
                                {{ $array_usdcad[$i] }}
                            @elseif ($volusdcad_sell_array[$i] != $volusdcad_buy_array[$i] && $sumabuy_sell < 0)
                            <td data-priority="0" scope="col" style="background-color: #FFEA20; font-weight:500">
                                {{ $array_usdcad[$i] }}
