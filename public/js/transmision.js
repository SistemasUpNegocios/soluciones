$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function () {
                ...
                if (acc == "new") {
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Transmisión añadida</h1>',
                        html: '<p style="font-family: Poppins">La transmisión se ha sido añadido correctamente</p>',
                        confirmButtonText:
    ...
    $(document).on("click", ".new", function (e) {
        ...
        acc = "new";
        $("#liveForm")[0].reset();
        $("#liveForm").attr("action", "/admin/addLive");
        $("#idInput").val("");


        $("#modalTitle").text("Añadir Link");
        $("#btnSubmit").text("Añadir Link");
    ...
    $(document).on("click", ".delete", function (e) {
        ...
        var conf;
        Swal.fire({
            title: '<h1 style="font-family: Poppins; font-weight: 700;">Eliminar Transmisión</h1>',
            html: '<p style="font-family: Poppins">¿Estás seguro de eliminar esta transmisión? esta opción no se puede deshacer</p>',
            icon: "warning",
            ...
            if (result.value) {
                $.post("/admin/deleteLive", { id: id }, function () {
                    table.ajax.reload(null, false);
                    Swal.fire({
                        icon: "success",
                        title: '<h1 style="font-family: Poppins; font-weight: 700;">Transmisión eliminada</h1>',
                        html: '<p style="font-family: Poppins">La transmisión se ha eliminado correctamente</p>',
                        confirmButtonText:
                            '<a style="font-family: Poppins">Aceptar</a>',
                        confirmButtonColor: "#01bbcc",
                    });
                ...
                Swal.fire({
                    ...
                    html: '<p style="font-family: Poppins">La transmisión no se ha eliminado</p>',
                    confirmButtonText:
                        '<a style="font-family: Poppins">Aceptar</a>',
                    confirmButtonColor: "#01bbcc",
                });
