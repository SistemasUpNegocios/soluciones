...
<?php $__env->startSection('title'); ?> Cleo Data <?php $__env->stopSection(); ?>
                ...
                <div class="card-body" style="padding-top: 20px;">
                    <div class="row justify-content-center" id="datosNueovos">
                        <div class="pagetitle d-flex justify-content-between align-items-center">
                            <h1><?php echo e($par); ?></h1>
                            <span id="ultimaHora">
                                Última actualización: <?php echo e(ucfirst(Carbon\Carbon::parse($fecha)->diffForHumans())); ?>
...
<script src="<?php echo e(asset('js/velocimetros.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\traders\resources\views/statusgrafica/showvelocimetro.blade.php ENDPATH**/ ?>