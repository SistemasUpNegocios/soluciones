        ...
        <div class="container" id="dataResume">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body ">
                            <p class="text-left">Beneficio Bruto: <?php echo e($beneficioBruto); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-left">Perdidas Bruto: <?php echo e($perdidasBruto); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-left">Beneficio Medio: <?php echo e($beneficioMedio); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <p class="text-left">Perdidas Medias: <?php echo e($perdidasMedias); ?></p>
                        </div>
                    </div>
                </div>
            </div>
