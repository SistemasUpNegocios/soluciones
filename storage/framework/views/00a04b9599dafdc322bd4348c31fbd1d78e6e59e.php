...
<div class="sidebar-nav sidebar offcanvas offcanvas-start activee" tabindex="-1" id="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li>
            ...
            <a class="<?php if(request()->is('/admin/portafoliosActivos2023')): ?> nav-link <?php else: ?> nav-link collapsed <?php endif; ?>"
                href="<?php echo e(url('/admin/portafoliosActivos2023')); ?>">
        ...
        <li class="nav-item">
            ...
            <a class="<?php if(request()->is('/admin/portafolioGraph2023')): ?> nav-link <?php else: ?> nav-link collapsed <?php endif; ?>"
                href="<?php echo e(url('/admin/portafolioGraph2023')); ?>">
            ...
            <ul id="equitybalance-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                ...
                <?php $__currentLoopData = $traders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        ...
                        <a class="ps-2" href="/admin/equityBalance2023/<?php echo e($trader->id); ?>">
        ...
        <li class="nav-item">
            ...
            <a class="<?php if(request()->is('/admin/historicos2023')): ?> nav-link <?php else: ?> nav-link collapsed <?php endif; ?>"
                href="<?php echo e(url('/admin/historicos2023')); ?>">
