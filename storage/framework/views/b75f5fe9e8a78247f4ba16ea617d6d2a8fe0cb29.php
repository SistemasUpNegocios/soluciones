...
<p class="font-weight-bold" style="text-align: right;">Fecha Inicio: <span style="font-weight:400"><?php echo e($fecha_inicio); ?> </span></p>
<p class="font-weight-bold" style="text-align: right;">Fecha Fin: <span style="font-weight:400"><?php echo e($fecha_fin); ?> </span></p>
<p class="font-weight-bold" style="text-align: right;">Trader: <span style="font-weight:400"><?php echo e($tradersNombre->Signal); ?> </span></p>
<p class="font-weight-bold" style="text-align: right;">Value: <span style="font-weight:400"><?php echo e($value); ?> </span></p>
    ...
    <div class="row d-flex justify-content-center">
        <table class="table table-striped table-bordered nowrap"
            ...
            <thead class="text-center"
                ...
                <tr>
                    <th style="font-size:7px;" data-priority="0" scope="col" colspan="7"><?php echo e($tradersNombre->Signal); ?></th>
                    ...
                    <th style="font-size:7px;" data-priority="0" scope="col">
                        <p style="font-size:7px;">Total: <?php echo e(number_format($profTotal->profit, 2)); ?></p>
                        <p style="font-size:7px;">Balance: <?php echo e(number_format($tradersNombre->Balance, 2)); ?></p>
                    </th>
                </tr>
            ...
            <tbody
                ...
                <?php $__currentLoopData = $monedas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moneda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($registros > 0): ?>
                        <tr>
                            <td><?php echo e($moneda); ?></td>
                            <td><?php echo e($registros); ?></td>
                            <td><?php echo e(number_format($pipsump[0]->sumpip, 2)); ?></td>
                            <td><?php echo e(number_format($pipsumn[0]->sumpip * -1, 2)); ?></td>
                            <td><?php echo e(number_format($pipsumtotal[0]->sumpip, 2)); ?></td>
                            <td><?php echo e($buy); ?></td>
                            <td><?php echo e($sell); ?></td>

                            <td><?php echo e(number_format($volumeavg, 2)); ?></td>
                            <td><?php echo e(number_format($volumestd[0]->std, 2)); ?></td>
                            <td><?php echo e(number_format($volumemax[0]->max, 2)); ?></td>

                            <td><?php echo e(number_format($advavg, 1)); ?></td>
                            <td><?php echo e(number_format($advstd[0]->std, 1)); ?></td>
                            <td><?php echo e(number_format($advmax[0]->max, 1)); ?></td>

                            <td><?php echo e(number_format($retavg, 1)); ?></td>
                            <td><?php echo e(number_format($retstd[0]->std, 1)); ?></td>
                            <td><?php echo e(number_format($retmax[0]->max, 1)); ?></td>

                            <td><?php echo e(number_format($pipavg, 1)); ?></td>
                            <td><?php echo e(number_format($pipstd[0]->std, 1)); ?></td>
                            <td><?php echo e(number_format($pipmin[0]->min, 1)); ?></td>
                            <td><?php echo e(number_format($pipmax[0]->max, 1)); ?></td>

                            <td><?php echo e(number_format($minavg / 60, 0)); ?></td>
                            <td><?php echo e(number_format($minstd[0]->std / 60, 0)); ?></td>
                            <td><?php echo e(number_format($minmax[0]->max / 60, 0)); ?></td>

                            <td><?php echo e(number_format($profsum->profit, 2)); ?></td>
                        </tr>
                    <?php endif; ?>
    ...
    <div class="row d-flex justify-content-center">
        ...
        <table class="table table-striped table-bordered nowrap"
            ...
            <thead class="text-center sticky-top"
                ...
                <tr>
                    <th data-priority="0" scope="col" colspan="2"><?php echo e($tradersNombre->Signal); ?></th>
                ...
                <?php $__currentLoopData = $monedas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moneda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($registros > 0): ?>
                        <tr>
                            ...
                            <td data-priority="0" scope="col"><?php echo e($countv); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($volmin, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countv2); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitadvol, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countv3); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($volmax, 2)); ?></p>
                            </td>


                            <td data-priority="0" scope="col"><?php echo e($countadv2); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitadadv, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countadv3); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitad2adv, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countadv4); ?><p style="font-size:9px">
                                    <?php echo e(number_format($advamax, 2)); ?></p>
                            </td>


                            <td data-priority="0" scope="col"><?php echo e($countret2); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitadret, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countret3); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitad2ret, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countret4); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($retrmax, 2)); ?></p>
                            </td>

                            <td data-priority="0" scope="col"><?php echo e($countp); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($pipsmin, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countp2); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitadpip, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countp3); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitad2pip, 2)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countp4); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($pipmaximo, 2)); ?></p>
                            </td>

                            <td data-priority="0" scope="col"><?php echo e($countm); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($minmin / 60, 0)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countm2); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitadmin / 60, 0)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countm3); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($mitad2min / 60, 0)); ?></p>
                            </td>
                            <td data-priority="0" scope="col"><?php echo e($countm4); ?> <p style="font-size:9px">
                                    <?php echo e(number_format($maxmin / 60, 0)); ?></p>
                            </td>
...
<?php /**PATH C:\laragon\www\traders\resources\views/tradersdata/imprimir.blade.php ENDPATH**/ ?>