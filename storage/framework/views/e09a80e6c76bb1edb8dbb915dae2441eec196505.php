    ...
    <?php $__currentLoopData = $traders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card-statistic-3 p-3">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center ">
                                        ...
                                        <?php endif; ?>
                                        <br>
                                        <span>Conflicto: <?php echo e($operaciones_conflicto); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\laragon\www\traders\resources\views/dashboard/pruebavida.blade.php ENDPATH**/ ?>